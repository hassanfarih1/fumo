  ...
  const handleGenerateClick = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/generateImage`, // Call your backend API
        {
          method: 'POST',
          body: formData,
        }
      ...
      if (!publicUrl) {
        throw new Error('Failed to retrieve the public URL of the generated image.');
      }
  ...
  return (
    <div className="flex flex-col justify-center text-center mt-16 space-y-5 relative z-10">
      <h1 className="text-3xl md:text-6xl font-black max-w-5xl mx-auto">
        ...
        <span className="text-primary">AI Image Generation</span>
      </h1>
      ...
      {loading && (
        <div className="absolute inset-0 -top-52 z-50 bg-black bg-opacity-50 backdrop-blur-sm">
